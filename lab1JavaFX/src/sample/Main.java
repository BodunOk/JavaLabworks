...
public class Main extends Application {
    ...
    public void start(Stage stage){
        ...
        Label equilateral = new Label("Равносторонний:");
        Label isosceles = new Label("Равнобедренный:");
        Label rectangular = new Label("Прямоугольный:");
        Button check = new Button("Проверить");

        HBox butWithRes = new HBox(450,rectangular,check);
        VBox results = new VBox(15,equilateral,isosceles,butWithRes);
        ...
        check.setOnAction(new EventHandler<ActionEvent>(){
            public void handle(ActionEvent e)
            {
                ...
                {
                    equilateral.setText("Равносторонний: да");
                    isosceles.setText("Равнобедренный: да");
                }
                else
                {
                    equilateral.setText("Равносторонний: нет");
                    ...
                    {
                        isosceles.setText("Равнобедренный: нет");
                    }
                }
                ...
                {
                    rectangular.setText("Прямоугольный: да");
                }
                else {
                    rectangular.setText("Прямоугольный: нет");
                }
